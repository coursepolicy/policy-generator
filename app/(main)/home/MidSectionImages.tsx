  ...
  return (
    <div className="mt-[72px] max-w-[1600px] xl:flex">
      <div className="flex flex-col items-center text-center xl:w-[100%] xl:max-w-[35%] xl:pl-[135px]">
        <div className="min-w-[290px]" aria-hidden="true">
          <Image
        ...
        <div className="mt-[34px] rounded-full bg-[#e0e4fd] p-1 px-2 text-[11px] font-bold text-[#38406e]">
          STEP ONE: BEFORE
        </div>
      ...
      <div
        className="relative mb-[120px] w-[100%] max-w-[150px] lg:block"
        aria-hidden="true"
      >
