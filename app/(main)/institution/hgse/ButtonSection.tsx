    ...
    <div className="lg:grid lg:grid-flow-row lg:pb-2 lg:pt-[20px]">
      <div className="mt-[50px] flex flex-col px-4 lg:mt-[0px] lg:flex-row lg:px-0">
        ...
        <Button
          asChild
          variant={"outline"}
          className="mb-[50px] inline-flex h-[40px] w-[195px] items-center justify-center gap-2.5 rounded-[100px] border border-[#4A558E] bg-transparent px-5 text-right text-sm leading-[25px] text-[#4A558E] hover:text-[#4A558E] lg:mb-0 lg:ml-[5px] lg:w-auto"
        >
