...
export default function LowerSection() {
  return (
    <section className="flex items-center justify-center bg-[#F6F6F9] px-4 lg:px-0">
      <div className="flex max-w-[1600px] flex-col lg:mr-[30px] lg:mt-[38px] lg:pb-[60px] lg:text-left">
        <div className="flex flex-col pt-[50px] text-left md:mt-[7px] lg:pt-0">
          <h2 className="px-4 font-serif text-[32px] lg:px-0 lg:pt-[35px]">
            Ready to get started?
          </h2>
          <p className="max-w-[740px] px-4 pt-[20px] text-left text-[16px] leading-normal text-stone-500 lg:px-0 lg:pt-[35px] lg:text-left">
